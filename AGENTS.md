...
| スキル                      | いつ発動するか                                        | パス                                                            |
| --------------------------- | ----------------------------------------------------- | --------------------------------------------------------------- |
| designing-workspace-ui      | ペイン変更・色変更・コンポーネント追加など UI 作業    | [SKILL.md](.Codex/skills/designing-workspace-ui/SKILL.md)      |
| shadcn                      | shadcn 部品の追加・カスタマイズ                       | [SKILL.md](.Codex/skills/shadcn/SKILL.md)                      |
| next-best-practices         | Next.js 16 のファイル規約・RSC 境界・async パターン等 | [SKILL.md](.Codex/skills/next-best-practices/SKILL.md)         |
| vercel-react-best-practices | React 性能最適化（70 ルール / 8 カテゴリ）            | [SKILL.md](.Codex/skills/vercel-react-best-practices/SKILL.md) |
...
`components/` 配下のファイルを編集する際は、以下を必ず守る。詳しい根拠と Incorrect/Correct ペアは [coding-rules.md](.Codex/skills/designing-workspace-ui/references/coding-rules.md) に集約している:
...
- `AGENTS.md` と `.Codex/skills/*` は配布される（受講生環境の AI が読む）
